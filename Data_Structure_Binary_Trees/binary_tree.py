...
class Node(object):
	...
	'''
		Compara el nodo con el objeto que se pasa como parametro comparando tambien 
		los sub-arboles izquierdo y derecho
		@param other
...
class BinaryTree(object):
	...
	'''
		Metodo que elimina a un elemento del arbol
		@param element
	...
	'''
		...
		el arbol
		@param element
			El elemento que contendra nuestro nodo
		@return 
	...
	'''
		Nos indica el tamanio del arbol
		@return
			El tamanio del arbol
	'''
	def get_size(self):
		return self.size

	'''
		Nos indica si el arbol esta vacio
		@return
	...
	'''
		Metodo que elimina todos los elementos del arbol
	'''
	def clear(self):
		self.root = None
		self.size = 0
